...
def generate_timeline_steps(
    ...
    if not is_registered:
        method = (
            "online via Form 6 or through your BLO"
            if rules["online_registration"]
            else "via Form 6 through your BLO"
        )
        steps.append(
            {
                "step_number": step_num,
        ...
        steps.append(
            {
                ...
                "description": (
                    "The ECI requires identification to vote. Your Electors Photo Identity Card (EPIC) "
